...
<container>
	...
	<div class="container-contact100" style="padding-top:8%" >
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate = "Digite um endereço de Email válido (e@a.com)">
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text" name="phone" placeholder="Digite seu número de telefone">
				</div>

				

				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Por favor digite uma mensagem">
					<span class="label-input100">Mensagem</span>
					<textarea class="input100" name="message" placeholder="Digite sua mensagem aqui..."></textarea>
				</div>
