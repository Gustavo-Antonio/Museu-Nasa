...
<head>
	...
	<link rel="stylesheet" href="css/mainSobre.css">
...
<section class="banner">
	<h1>
		Um pouco sobre a NASA
	</h1>
	<p>
		Saiba um pouco mais sobre esta grande empresa.
	</p>
	<nav>
		<button>
...
<br><br><br>
<section id="a"  class="mid-content anime">

	<img src="imgs/ball1logonasa.png" alt="" width="30%" id="imagem">

	<div class="lado-b">
		<i><h1 style="margin: 0;"> "Qual o nosso objetivo ? -  <b>NASA"</b></h1></i>
		<p style="margin: 0;">
		Criada pelos EUA em 1 de outubro de 1958, com o intuito de acabar com a dispersão de esforços e rivalidades entre os três ramos das Forças Armadas na exploração espacial.

Os objetivos fixados à NASA, iniciais de National Aeronautics and Space Administration (Administração Nacional da Aeronáutica e do Espaço), são: a realização de estudos científicos da atmosfera da Terra e do espaço cósmico; a conceção e o desenvolvimento de aviões e engenhos espaciais; a investigação dos meios adequados à manutenção da supremacia dos EUA nos domínios da Aeronáutica e da Astronáutica; o estudo da sua utilização para fins pacíficos; e a coordenação dos esforços dos organismos públicos, industriais e científicos nos domínios da Aeronáutica e da Astronáutica.
		</p>
	</div>
</section>
<br><br><br><br>
...
<section class="final-content">
	<h1>Para saber mais, embarque no nosso tour!</h1>
	<br><br><br>
	<h2>
		"Clique no botão abaixo para entrar nessa história e começar a conhecer o legado desta grande empresa" 
	</h2>
	

	<button>

		<a style="color: white; text-decoration: none; font-size: 16px" href="tour.php">Começe o tour</a>
	</button>
</section>
