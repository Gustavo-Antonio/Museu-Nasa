...
<p>
    pela grande história da NASA.
</p>

<nav>
    <button>

      <a style="color: white; text-decoration: none; font-size: 16px" href="#a">Começar</a>
  </button>
</nav>

</section>
<br><br>
<center><h1>A Historia Da Nasa</h1></center>

<section class="anime container-fluid" style="max-width: 800px; margin-top: 5%;">
    <div class="img-right">
        <img src="imgs/telescope.png" alt="Img 1"  height="100">
    </div>
    <div class="row col-lg-8 col-ms-6 col-12 ">
        <h2 align="right" style="font-family: 'Poppins', sans-serif;">Lavar as mãos</h2>
        <h5>Controle Dual Shock p/ PS2 Mais conforto na hora de jogar. O controle Dual Shock para PS2 traz para os gamers tecnologia com um design ergonômico, para um melhor posicionar das mãos.Dual Shock dispõem de dois joysticks analógicos, botões sensíveis a pressão e dois motores internos para máxima</h5>
        <a target="_blank" href="https://coronavirus.saude.gov.br">Ver Mais</a>
    </div>
</section>
<section class="anime container-fluid" style="max-width: 800px; margin-top: 5%;">
    <div class="img-right">
