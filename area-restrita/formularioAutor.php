...
<section class="anime box container-fluid"id="a">
  ...
  <div class="row">
    <div class="b">
      <h3 style="color: #ff3333;">Cadastro Autor</h3>
      <form name="cadastro" method="post" action="cadastrar-autor.php">
        <input class="tipo" type="text" name="txtNome" placeholder="Nome do Autor"><br>
        <input class="tipo" type="text" name="dataNas" placeholder="Data Nascimento Autor"><br>
        <input class="tipo" type="text" name="dataFal" placeholder="Data Falecimento Autor"><br>
        <input class="tipo" type="text" name="naci" placeholder="Nacionalidade Autor"><br><br>
