...
<section class="anime box container-fluid"id="a">
  ...
  <div class="row">
    <div class="b">
      <h3 style="color: #ff3333;">Cadastro Categoria</h3><br>
      <form name="cadastro" method="post" action="cadastrar-categoria.php">
        <input class="tipo" type="text" name="txtNome" placeholder="Nome Categoria"><br><br>
