...
<section class="anime box container-fluid"id="a">
  ...
  <div class="row">
    <div class="b">
      ...
      <form name="cadastro" method="post" action="cadastrar-obra.php">
        <input class="tipo" type="text" name="txtNomeObra" placeholder="Nome Da Obra"><br>
        <input class="tipo jumper" type="text" name="dataObra" placeholder="Data Da Obra"><br>
        <select class="jumper" name='tipoAutor'>
          <option value="" disabled selected>Autor Da Obra</option>
        ...
        <br>
        <select class="jumper" name='tipoCategoria'>
          <option value="" disabled selected>Categoria Da Obra</option>
        ...
        <br>
        <select class="jumper" name='tipoPeriodo'>
          <option value="" disabled selected>Período Da Obra</option>
          <?php foreach ($listaPeriodo as $linha) { ?>
            <option value=<?php echo $linha['idPeriodo'] ?>>
              <?php echo $linha['nomePeriodo'] ?>
            </option>
          <?php }?>
        </select>
