...
<section id="a"  class="mid-content anime">
	...
	<img src="imgs/NASA.jpg" alt="" width="30%" id="imagem">

	<div class="lado-b">
		<i><h1 style="margin: 0;"> "Um Pouco Sobre o Tour da <b>NASA"</b></h1></i>
		<p style="margin: 0;">
		O objetivo do nosso tour é mostrar e ensinar um pouco sobre a criação, evolução e conquistas desta grande empresa que é a NASA. Neste tour você vai aprender sobre as principais conquistas, os principais artefatos e um pouco sobre este gigantesco universo que a NASA contribuiu para ser descoberto. Embarce com a gente, e saía daqui olhando o universo com outros olhos.
		</p>
	</div>
</section>
...
<div id="banner-projetoNasa">
	<h1><b><i>"Um pequeno passo para o homem, mas um grande salto para a humanidade."</i></b></h1>
</div>

<br><br><br>

<section class="final-content">
	<h1>Vamos Começar o Tour?</h1>
	<br><br><br>
	<h2>
		"Clique no botão abaixo para embarcar nessa história e começar a conhecer o legado desta grande empresa" 
	</h2>
